...
public class MinhasVendasView extends JPanel {
    ...
    private void initComponents() {
        ...
        /// Visibilidade de emojis
        btnFiltrar.setFont(new java.awt.Font("Segoe UI Emoji", Font.BOLD, 16));
        btnLimparFiltros.setFont(new java.awt.Font("Segoe UI Emoji", Font.BOLD, 16));
        btnExportarPDF.setFont(new java.awt.Font("Segoe UI Emoji", Font.BOLD, 16));
        btnVoltar.setFont(new java.awt.Font("Segoe UI Emoji", Font.BOLD, 18));
    ...
    private void setupLayout() {
        ...
        tabbedPane.setFont(new java.awt.Font("Segoe UI Emoji", java.awt.Font.PLAIN, 14));
    ...
    private JPanel criarPainelFiltros() {
        ...
        lblTitulo.setFont(new java.awt.Font("Segoe UI Emoji", java.awt.Font.BOLD, 14));
    ...
    private JPanel criarCardEstatisticaPessoal(String titulo, JLabel valorLabel, String descricao) {
        ...
        valorLabel.setFont(new java.awt.Font("Segoe UI Emoji", java.awt.Font.BOLD, 16));
    ...
    private void calcularMinhasEstatisticas() {
        ...
        BigDecimal ticketMedio = totalVendas > 0 ?
                faturamentoTotal.divide(new BigDecimal(totalVendas), 2, RoundingMode.HALF_UP) :
                BigDecimal.ZERO;
    ...
    private void configurarTituloComEmoji(JFreeChart chart, String titulo) {
        TextTitle title = new TextTitle(titulo);
        title.setFont(new java.awt.Font("Segoe UI Emoji", java.awt.Font.BOLD, 12));
        chart.setTitle(title);
    }

    private void configurarLegenda(JFreeChart chart) {
        LegendTitle legend = chart.getLegend();
        if (legend != null) {
            legend.setFrame(new BlockBorder(Color.WHITE));
            legend.setItemFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 10));
    ...
    private void gerarMeusGraficos() {
        ...
        if (minhasVendasFiltradas == null || minhasVendasFiltradas.isEmpty()) {
            ...
            JFreeChart chartVendasDia = ChartFactory.createBarChart(
                    null, "Dia", "Quantidade", dsVendasDia
            );
            configurarTituloComEmoji(chartVendasDia, "📈 Vendas por Dia");
            CategoryPlot plot1 = chartVendasDia.getCategoryPlot();
            plot1.getDomainAxis().setTickLabelFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 9));
            BarRenderer renderer1 = (BarRenderer) plot1.getRenderer();
            renderer1.setItemMargin(0.1);
            configurarLegenda(chartVendasDia);
            ...
            JFreeChart chartFaturamentoDia = ChartFactory.createLineChart(
                    null, "Dia", "Valor (MT)", dsFaturamentoDia
            );
            configurarTituloComEmoji(chartFaturamentoDia, "💰 Faturamento por Dia");
            CategoryPlot plot2 = chartFaturamentoDia.getCategoryPlot();
            plot2.getDomainAxis().setTickLabelFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 9));
            LineAndShapeRenderer renderer2 = (LineAndShapeRenderer) plot2.getRenderer();
            renderer2.setItemMargin(0.1);
            configurarLegenda(chartFaturamentoDia);
            ...
            JFreeChart chartClientes = ChartFactory.createPieChart(
                    null, dsClientes, true, true, false
            );
            configurarTituloComEmoji(chartClientes, "👥 Top Clientes");
            PiePlot piePlot = (PiePlot) chartClientes.getPlot();
            piePlot.setLabelFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 9));
            configurarLegenda(chartClientes);
            ...
            JFreeChart chartComparacao = ChartFactory.createBarChart(
                    null, "Mês", "Faturamento (MT)", dsComparacao
            );
            configurarTituloComEmoji(chartComparacao, "📅 Comparação Mensal");
            CategoryPlot plot4 = chartComparacao.getCategoryPlot();
            plot4.getDomainAxis().setTickLabelFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 9));
            BarRenderer renderer4 = (BarRenderer) plot4.getRenderer();
            renderer4.setItemMargin(0.1);
            configurarLegenda(chartComparacao);
